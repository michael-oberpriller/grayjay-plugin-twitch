...
function getLiveVideo(url, video_details = true) {
    ...
    const hls_url =`https://eu3.luminous.dev/live/${login}.m3u8?acmb=e30=&allow_source=true&fast_bread=true&p=&play_session_id=&player_backend=mediaplayer&playlist_include_framerate=true&supported_codecs=avc1&transcode_mode=vbr_v1`
